...
var phraseArray = [ "#heylibrary",
                    ...
                    "Then came the film and burst this prison",
                    "The text is the thunder rolling long afterward",
                    "The gaze of nature thus awakened dreams and pulls the poet after it",
                    "Do not write the conclusion of a work in your familiar study",
                    "Like a clock of life on which the seconds race, the page number hangs over the characters in a novel",
                    ...
                    "join me among piles of volumes that are seeing daylight again after two years of darkness",
                    ...
                    "write because you love the shape of stories and sentences and the creation of different words on a page",
                    "What an astonishing thing a book is",
                    "I hate writing, I love having written.",
                    "a bad novel tells us the truth about its author",
                    "see the writing as emerging like a long scroll of ink from the index finger",
                    "the basic material a writer works with is acquired before the age of fifteen",
                    "their words make the souls of their readers stronger, brighter, deeper",
                    "write what you wish to write, that is all that matters",
                    ...
                    "in the beginning he is only proposing to tell a little tale, a very little tale, a six-page tale",
                    ...
                    "after seein' Los Angeles, and this here story I'm about to unfold",
                    "I guess that's the way the whole durned human comedy keeps perpetuatin' itself",
                    "At least that was the handle his loving parents gave him",
                    ...
                    "Oh, Tennessee, why did you lie? I come together in the middle of the night",
                    ...
                    "the longing for yet another strange land, grew especially strong in spring",
                    ...
                    "The women talk long-distance to grandparents of growing boys",
                    "To-whit! To-who! -- a merry note",
                    "Spring time in Florida is not a matter of peeping violets or bursting buds merely",
                    "the day, which was one of the first of spring, cheered even me by the loveliness of its sunshine",
                    "To arise one smoking spring and find one's youth has taken off for greener parts",
                    "The winter’s accumulation of paper, Pages I do not want to read Again, useless words, fragments, errors",
                    ...
                    "from the reasoning faculty mind (nous) and information (istoria) to human thought (oiesis)",
                    "they leave philosophy and lead the lower life of ambition",
                    "if the law is finally approved, then the author leaves the theatre in high delight",
                    "every discourse ought to be a living creature, having a body of its own and a head and feet",
                    "there should be a middle, beginning, and end, adapted to one another and to the whole",
                    "divine madness was subdivided into four kinds, prophetic, initiatory, poetic, erotic",
                    "their art is not the same with the art of those whom you call, and rightly, in my opinion, dialecticians",
                    "All of them agree in asserting that a speech should end in a recapitulation",
                    "to implant the conviction or virtue which you desire, by the right application of words and training",
                    "there is something yet to be said of propriety and impropriety of writing",
                    ...
                    "when nothing else would do, he got hold of the book, and looked at what he most wanted to see",
                    "for that roll, as I suspect, is the actual discourse",
                    "according to another version of the story she was taken from Areopagus",
                    "Ancient sages, men and women, who have spoken and written of these things, would rise up",
                    "Leaving the tale to its fate, I will cross the river",
                    "influential statesmen are ashamed of writing speeches and leaving them in a written form",
                    "The disgrace begins when a man writes not well, but badly",
                    "rhetoric is a mere routine and trick, not an art",
                    "To me there seem to be a great many holes in their web",
                    "The only thing very noticeable about Nebraska was that it was still, all day long, Nebraska.",
                    "a 'Life of Jesse James,' which I remember as one of the most satisfactory books I have ever read.",
                    ...
                    "The red of the grass made all the great prairie the colour of winestains",
                    "Antonia laughed and squeezed my hand as if to tell me how glad she was I had come",
                    "Before I got into the wagon, he took a book out of his pocket, opened it, and showed me a page with two alphabets",
                    ...
                    "He was telling a long story, and as he went on, Antonia took my hand under the table",
                    "when we were lying in the straw, under the jolting and rattling Antonia told me as much of the story as she could",
                    "For Antonia and me, the story of the wedding party was never at an end",
	            "those little brown shavings, which the Shimerdas had brought so far and treasured so jealously, were dried mushrooms",
                    ...
                    "Right on the two inch tape, The Abstract poet incognito, runs the cape",
                    ...
                    "The fog and the smog of news media that logs false narratives of Gods",
                    "So just clean out your ears and just check the word",
                    "But see I create sounds that make your ears go numb",
                    "Women love the voice, brothers dig the lyrics",
                    "Can I kick it? To my Tribe that flows in layers",
                    "but get books, sit down anywhere, and go to reading for yourself",
                    "I abstain from reading reports of attacks upon myself, wishing not to be provoked",
                    "A capacity and taste for reading gives access to whatever has already been discovered",
                    "do something worth writing or write some thing worth reading",
                    ...
                    "my judgment is, that he reads the books for himself without an instructor",
                    ...
                    "Let us demonstrate with one of your workers, for actions speak louder than words.",
                    "This letter will help you to get work. Now make good.",
                    "Can you imagines us in a little home like that?",
                    "An accident occurred in a department store. The night watchman broke his leg.",
                    "Look! I can do it blindfolded.",
                    "I must punch the time clocks.",
                    "The mechanic and his new assistant put to work repairing the long idle machinery.",
                    "I've been waiting an hour for roast duck.",
                    "Let's rehearse your song. I forgot the words.",
                    "I'll write them on your cuff.",
                    "You're great! I'll give you a steady job.",
                    ...
                    "such stories were for the most part made up by persons who would themselves have been glad to sin if they had been able",
                    "greedily read three newspapers a day, and declared he did not read the Moscow papers on principle!",
                    "But more than a month passed, real winter had come, and everything was still clear in his memory",
                    ...
                    "every man had his real, most interesting life under the cover of secrecy and under the cover of night",
                    "Walter Mitty drove on toward Waterbury in silence",
                    "IT WAS a dark autumn night. The old banker was walking",
                    "There had been many clever men there, and there had been interesting conversations",
                    "He was allowed to have a musical instrument and books, and was allowed to write letters",
                    ...
                    "but in your books I have drunk fragrant wine, I have sung songs, I have hunted stags and wild boars in the forests",
                    ...
                    "How touching to have the meaning of Christmas brought to us by cola, fast food, and beer",
                    "He took the Who's feast, he took the Who pudding, he took the roast beast",
                    "I was told that it is an elf's lot to remain merry in the face of torment and adversity",
                    "I have felt that the yuletide is a special hell for those families who have suffered any loss",
                    ...
                    "Like kids who only ever get socks for Christmas",
                    "Nick chided a censor, who wished some books gone, and suggested she scan Fahrenheit 451",
                    "Twas a cold Yuletide evening, and I wandered the stacks, shelving multiple titles",
                    ...
                    "can tell a lot about an area from its library, and I'd never discount the usefulness of town archives",
                    "The warehouse of this memory is called the library",
                    "I think I've just understood something! I've got to go to the library!",
                    "perfect tranquility of life, which is nowhere to be found but in retreat, a faithful friend and a good library",
                    ...
                    "His library was a fine dark place bricked with books",
                    "She liked the combined smell of worn leather bindings, library past and freshly inked stamping pads",
                    "every library is in some sense a reflection of its readers",
                    "returned to her chair, took off her coat and hat, opened her book and forgot the world again",
                    "muttering that if one brick was removed the whole library was liable to collapse",
                    "Picture books build readers, Mr. Leon",
                    "my dear, should spend more time in a library. It's not just a hiding place",
                    "#oklibrary",
